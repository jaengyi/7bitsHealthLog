...
fun ExerciseScreen(modifier: Modifier = Modifier) {
    Column(
        ...
        Text(text = "종목", style = MaterialTheme.typography.headlineMedium)
        Text(
            text = "SCR-EXR-001 · 구현 예정",
...
private fun ExerciseScreenDarkPreview() {
    MyFitTheme(darkTheme = true) { ExerciseScreen() }
}

@Preview(name = "light", showBackground = true)
@Composable
private fun ExerciseScreenLightPreview() {
    MyFitTheme(darkTheme = false) { ExerciseScreen() }
}
