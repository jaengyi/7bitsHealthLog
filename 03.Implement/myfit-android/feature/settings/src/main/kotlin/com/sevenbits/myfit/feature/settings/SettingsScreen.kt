...
fun SettingsScreen(modifier: Modifier = Modifier) {
    Column(
        ...
        Text(text = "더보기", style = MaterialTheme.typography.headlineMedium)
        Text(
            text = "SCR-CMN-003 · 구현 예정",
...
private fun SettingsScreenDarkPreview() {
    MyFitTheme(darkTheme = true) { SettingsScreen() }
}

@Preview(name = "light", showBackground = true)
@Composable
private fun SettingsScreenLightPreview() {
    MyFitTheme(darkTheme = false) { SettingsScreen() }
}
